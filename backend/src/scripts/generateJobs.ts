...
const ROLES: RoleTemplate[] = [
  ...
  {
    titleBase: "Chef",
    intro: "We are hiring a {seniority}Chef to lead our kitchen and craft memorable menus.",
    responsibilities: [
      "Design seasonal menus and daily specials.",
      "Oversee food preparation, plating, and portion control.",
      "Manage kitchen staff scheduling and training.",
      "Monitor food cost, waste, and inventory ordering.",
      "Ensure compliance with food safety and sanitation standards.",
      "Maintain consistent quality across dishes during service.",
      "Coordinate with front-of-house on service timing.",
    ],
    skills: ["menu development", "food preparation", "kitchen management", "food safety", "inventory control", "cost control", "plating and presentation"],
    niceToHave: ["ServSafe certification", "culinary degree", "banquet experience"],
  },
  {
    titleBase: "Receptionist",
    intro: "We're looking for a {seniority}Receptionist to be the welcoming first point of contact for our office.",
    responsibilities: [
      "Greet visitors and direct them to the right person or department.",
      "Answer, screen, and route incoming phone calls.",
      "Manage scheduling and calendar coordination for meetings.",
      "Sort and distribute incoming mail and deliveries.",
      "Maintain a tidy, organized front desk and reception area.",
      "Order office supplies and support basic administrative tasks.",
    ],
    skills: ["front desk operations", "phone etiquette", "scheduling", "office administration", "customer service", "multitasking", "Microsoft Office"],
    niceToHave: ["multilingual communication", "visitor management systems", "calendar software"],
  },
  {
    titleBase: "Public Relations Specialist",
    intro: "We are hiring a {seniority}Public Relations Specialist to manage our brand's public image and media relationships.",
    responsibilities: [
      "Write and distribute press releases and media pitches.",
      "Build and maintain relationships with journalists and media outlets.",
      "Prepare talking points and briefing materials for spokespeople.",
      "Monitor media coverage and brand sentiment.",
      "Coordinate crisis communication response plans.",
      "Support event planning for press and public engagements.",
    ],
    skills: ["media relations", "press releases", "crisis communication", "brand messaging", "public speaking prep", "media monitoring", "copywriting"],
    niceToHave: ["Cision", "social media strategy", "executive communications"],
  },
  {
    titleBase: "Electrician",
    intro: "We're seeking a {seniority}Electrician to install and maintain electrical systems safely.",
    responsibilities: [
      "Install, maintain, and repair electrical wiring and fixtures.",
      "Read blueprints and electrical schematics.",
      "Diagnose electrical faults and perform repairs.",
      "Ensure work complies with electrical codes and safety standards.",
      "Inspect systems for wear and recommend preventive maintenance.",
      "Coordinate with contractors on new construction projects.",
    ],
    skills: ["electrical wiring", "blueprint reading", "electrical code compliance", "troubleshooting", "circuit installation", "safety procedures"],
    niceToHave: ["journeyman license", "industrial electrical experience", "solar installation"],
  },
  {
    titleBase: "Plumber",
    intro: "We are hiring a {seniority}Plumber to install and repair plumbing systems for residential and commercial clients.",
    responsibilities: [
      "Install and repair pipes, fixtures, and water systems.",
      "Diagnose and fix leaks, clogs, and plumbing failures.",
      "Read blueprints to plan pipe layouts.",
      "Ensure work complies with local plumbing codes.",
      "Perform routine maintenance and inspections.",
      "Provide clear estimates and communicate with clients.",
    ],
    skills: ["pipefitting", "fixture installation", "leak diagnosis", "plumbing code compliance", "blueprint reading", "customer communication"],
    niceToHave: ["master plumber license", "commercial plumbing experience", "backflow certification"],
  },
  {
    titleBase: "Delivery Driver",
    intro: "We're looking for a {seniority}Delivery Driver to ensure timely, safe deliveries to our customers.",
    responsibilities: [
      "Load, transport, and deliver packages or goods on schedule.",
      "Plan efficient delivery routes.",
      "Inspect vehicle for safety before and after routes.",
      "Obtain delivery confirmations and handle basic paperwork.",
      "Provide friendly, professional service to customers.",
      "Report vehicle issues or delivery delays promptly.",
    ],
    skills: ["route planning", "safe driving", "time management", "customer service", "vehicle inspection", "delivery documentation"],
    niceToHave: ["commercial driver's license", "GPS/fleet software experience", "clean driving record"],
  },
  {
    titleBase: "Warehouse Associate",
    intro: "We are hiring a {seniority}Warehouse Associate to keep our warehouse operations running smoothly.",
    responsibilities: [
      ...
      "Keep the warehouse organized and compliant with safety standards.",
      "Support cycle counts and inventory audits.",
    ],
    skills: ["order picking", "inventory management", "forklift operation", "warehouse safety", "shipping and receiving", "inventory systems"],
    niceToHave: ["forklift certification", "WMS software experience", "OSHA training"],
  },
  {
    titleBase: "Flight Attendant",
    intro: "We're seeking a {seniority}Flight Attendant to ensure passenger safety and comfort onboard.",
    responsibilities: [
      "Conduct pre-flight safety checks and briefings.",
      "Assist passengers with boarding, seating, and luggage.",
      "Serve food, beverages, and respond to passenger needs.",
      "Respond calmly and effectively to in-flight emergencies.",
      "Ensure compliance with aviation safety regulations.",
      "Provide excellent customer service throughout the flight.",
    ],
    skills: ["passenger safety", "emergency response", "customer service", "conflict de-escalation", "aviation regulations", "first aid"],
    niceToHave: ["CPR/first aid certification", "multilingual communication", "international travel experience"],
  },
  {
    titleBase: "Pharmacist",
    intro: "We are hiring a {seniority}Pharmacist to dispense medications and provide patient care guidance.",
    responsibilities: [
      "Review and fill prescriptions accurately.",
      "Counsel patients on medication use and interactions.",
      "Verify dosages and check for drug interactions.",
      "Collaborate with physicians on treatment plans.",
      "Maintain compliance with pharmacy regulations.",
      "Manage pharmacy inventory and controlled substances.",
    ],
    skills: ["prescription verification", "patient counseling", "drug interaction screening", "pharmacy regulations", "inventory management", "clinical knowledge"],
    niceToHave: ["PharmD license", "immunization certification", "specialty pharmacy experience"],
  },
  {
    titleBase: "Veterinarian",
    intro: "We're looking for a {seniority}Veterinarian to provide compassionate care for animal patients.",
    responsibilities: [
      "Examine, diagnose, and treat animal patients.",
      "Perform surgeries and administer treatments.",
      "Advise pet owners on preventive care and nutrition.",
      "Maintain accurate medical records.",
      "Collaborate with veterinary technicians on patient care.",
      "Respond to emergency cases as needed.",
    ],
    skills: ["animal diagnostics", "surgery", "preventive care", "clinical documentation", "client communication", "emergency care"],
    niceToHave: ["DVM license", "exotic animal experience", "board certification"],
  },
  {
    titleBase: "Social Worker",
    intro: "We are hiring a {seniority}Social Worker to support individuals and families in need.",
    responsibilities: [
      ...
      "Advocate for clients within social and healthcare systems.",
      "Collaborate with other agencies and care providers.",
    ],
    skills: ["case management", "crisis intervention", "client assessment", "counseling", "community resources", "documentation"],
    niceToHave: ["LCSW license", "trauma-informed care training", "bilingual communication"],
  },
  {
    titleBase: "Librarian",
    intro: "We're seeking a {seniority}Librarian to support our community's access to information and resources.",
    responsibilities: [
      "Assist patrons with research and resource discovery.",
      "Catalog and organize library collections.",
      "Plan and host community programs and events.",
      "Manage circulation and digital library systems.",
      "Curate collections aligned with community interests.",
      "Train patrons on library technology and databases.",
    ],
    skills: ["cataloging", "reference services", "collection development", "library systems", "program planning", "information literacy"],
    niceToHave: ["MLIS degree", "archival experience", "digital literacy instruction"],
  },
  {
    titleBase: "Real Estate Agent",
    intro: "We are hiring a {seniority}Real Estate Agent to help clients buy, sell, and rent properties.",
    responsibilities: [
      "Guide clients through buying and selling transactions.",
      "List properties and coordinate showings.",
      "Negotiate offers and contracts on behalf of clients.",
      "Research market trends and comparable properties.",
      "Build and maintain a client referral network.",
      "Ensure compliance with real estate regulations.",
    ],
    skills: ["property listings", "contract negotiation", "market analysis", "client relationship management", "real estate regulations", "prospecting"],
    niceToHave: ["real estate license", "MLS experience", "luxury property sales"],
  },
  {
    titleBase: "Insurance Agent",
    intro: "We're looking for a {seniority}Insurance Agent to help clients find the right coverage for their needs.",
    responsibilities: [
      "Assess client needs and recommend insurance policies.",
      "Prepare and present policy quotes.",
      "Process new applications, renewals, and claims support.",
      "Build and maintain long-term client relationships.",
      "Stay current on policy changes and regulations.",
      "Meet sales targets and retention goals.",
    ],
    skills: ["policy recommendation", "client needs analysis", "insurance regulations", "sales", "relationship management", "claims support"],
    niceToHave: ["insurance license", "CRM software experience", "life and health certification"],
  },
  {
    titleBase: "Bank Teller",
    intro: "We are hiring a {seniority}Bank Teller to provide accurate, friendly service to banking customers.",
    responsibilities: [
      "Process deposits, withdrawals, and account transactions.",
      "Balance cash drawers and maintain transaction accuracy.",
      "Assist customers with account inquiries and basic services.",
      "Identify opportunities to refer customers to bank products.",
      "Follow security and compliance procedures.",
      "Resolve customer issues or escalate as needed.",
    ],
    skills: ["cash handling", "transaction processing", "customer service", "compliance procedures", "account management", "attention to detail"],
    niceToHave: ["banking software experience", "notary certification", "cross-selling experience"],
  },
  {
    titleBase: "Event Planner",
    intro: "We're seeking a {seniority}Event Planner to design and execute memorable events.",
    responsibilities: [
      "Coordinate all logistics for events from concept to execution.",
      "Manage vendor relationships and contracts.",
      "Develop and track event budgets.",
      "Design event timelines and run-of-show schedules.",
      "Handle on-site event coordination and troubleshooting.",
      "Gather client feedback to improve future events.",
    ],
    skills: ["event logistics", "vendor management", "budget management", "timeline planning", "client communication", "on-site coordination"],
    niceToHave: ["catering coordination", "wedding planning experience", "corporate event experience"],
  },
  {
    titleBase: "Personal Trainer",
    intro: "We are hiring a {seniority}Personal Trainer to help clients reach their fitness goals safely.",
    responsibilities: [
      "Design personalized workout programs for clients.",
      "Demonstrate proper exercise form and technique.",
      "Track client progress and adjust plans accordingly.",
      "Educate clients on nutrition and healthy habits.",
      "Ensure a safe training environment and equipment use.",
      "Motivate clients to stay consistent with their goals.",
    ],
    skills: ["fitness programming", "exercise technique coaching", "client progress tracking", "nutrition guidance", "motivation and coaching", "gym safety"],
    niceToHave: ["personal training certification", "CPR/AED certification", "specialized training niches"],
  },
  {
    titleBase: "Truck Driver",
    intro: "We're looking for a {seniority}Truck Driver to transport goods safely across long distances.",
    responsibilities: [
      "Operate commercial trucks to deliver freight on schedule.",
      "Perform pre-trip and post-trip vehicle inspections.",
      "Plan routes considering traffic, weather, and regulations.",
      "Maintain accurate delivery logs and paperwork.",
      "Ensure cargo is properly secured for transport.",
      "Comply with hours-of-service and safety regulations.",
    ],
    skills: ["commercial driving", "route planning", "vehicle inspection", "cargo securing", "logbook documentation", "DOT compliance"],
    niceToHave: ["CDL license", "hazmat endorsement", "long-haul experience"],
  },
  {
    titleBase: "Construction Laborer",
    intro: "We are hiring a {seniority}Construction Laborer to support work on active job sites.",
    responsibilities: [
      "Assist with site preparation, material handling, and cleanup.",
      "Operate hand and power tools safely.",
      "Follow blueprints and instructions from site supervisors.",
      "Support carpentry, concrete, or masonry crews as needed.",
      "Maintain a clean, hazard-free job site.",
      "Comply with all safety regulations and protocols.",
    ],
    skills: ["site preparation", "power tool operation", "material handling", "blueprint reading", "safety compliance", "manual labor"],
    niceToHave: ["OSHA 10/30 certification", "equipment operation experience", "scaffolding experience"],
  },
];
